...
Router::add('GET', 'home', 'AnnonceController', 'home');
Router::add('GET', 'getannonce', 'AnnonceController', 'searchannonce');
Router::add('GET', 'reservation/{id}', 'ReservationController', 'getAnnonceReserve');
Router::add('POST', 'reserver', 'ReservationController', 'reserver');
Router::add('GET', 'paiement/{id}', 'PaiementController', 'showPaiement');
Router::add('GET', 'process-transaction/{id}', 'ReservationController', 'succespaymentreservation');
