        ...
        <div class="flex justify-center space-x-8 overflow-x-auto pb-4">
            <button class="flex flex-col items-center space-y-2 min-w-[80px] text-rose-500">
                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    ...
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 22l9-4.5-9-4.5-9 4.5 9 4.5z"></path>
                </svg>
            ...
            <button class="flex flex-col items-center space-y-2 min-w-[80px] text-gray-500 hover:text-rose-500">
                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M4 12l1-1 7-7 7 7 1 1v7a1 1 0 01-1 1h-4a1 1 0 01-1-1v-4H9v4a1 1 0 01-1 1H4a1 1 0 01-1-1v-7z">
                    </path>
                </svg>
            ...
            <button class="flex flex-col items-center space-y-2 min-w-[80px] text-gray-500 hover:text-rose-500">
                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M8 21h8a2 2 0 002-2V7L12 3 6 7v12a2 2 0 002 2z"></path>
                </svg>
            ...
            <button class="flex flex-col items-center space-y-2 min-w-[80px] text-gray-500 hover:text-rose-500">
                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M12 3L4 21h16L12 3zM12 9v4"></path>
                </svg>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            <div class="group">
                <div class="relative aspect-square rounded-xl overflow-hidden">
                    <img src="https://via.placeholder.com/400x300" alt="Villa de luxe avec piscine"
                        class="object-cover w-full h-full group-hover:scale-105 transition-transform duration-200" />
                    <button
                        class="absolute top-4 right-4 p-2 rounded-full bg-white shadow-md hover:scale-110 transition-transform">
                        ♥
                    </button>
                </div>
